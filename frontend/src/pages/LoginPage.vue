...
const handleLogin = async () => {
  ...
  try {
    // TODO: make the login request (reference Postman login request)
    // TODO: once you have the token
    //  - use console.log() or alert() to view it
    //  - set it in the axios instance using the setAuthToken() function
    //  - redirect the user to the home page using `router.push('/')`
  } catch (err) {
